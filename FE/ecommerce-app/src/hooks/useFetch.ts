...
const useApi = <T>(method: HttpMethod, showLoading: boolean, projectId?: string) => {
  ...
  const finalToken =
    getBearerToken() ??
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwidXNlcm5hbWUiOiJhZG1pbiIsImVtYWlsIjoiYWRtaW5AZ21haWwuY29tIiwicm9sZXMiOlsiYWRtaW4iXSwiaWF0IjoxNzQ1MDQ1ODMwLCJleHAiOjE3NDc2Mzc4MzB9.3DT4cOADH9fEVUoxmYdV_1L39km_crTxxqa-Hl7RPUg";
