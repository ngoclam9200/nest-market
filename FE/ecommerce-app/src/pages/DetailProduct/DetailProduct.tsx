                  ...
                  <div className="row mb-50 mt-30">
                    ...
                    <div className="col-md-6 col-sm-12 col-xs-12">
                      <div className="detail-info pr-30 pl-30">
                        ...
                        <div className="product-detail-rating">{/* <RatingProduct></RatingProduct> */}</div>
                        ...
                        <div className="short-desc mb-30">
                          <p className="font-lg">
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam rem officia, corrupti reiciendis minima nisi modi, quasi, odio minus dolore impedit
                            fuga eum eligendi.
                          </p>
                        </div>
                        ...
                        <div className="detail-extralink mb-20 flex-wrap">
                          ...
                          <div className="product-extra-link2">
                            <ButtonAddCart padding={"11px 20px 11px 30px"}></ButtonAddCart>
                          </div>
                          <div className="product-extra-link2">
                        ...
                        <div className="font-xs">
                          ...
                          <ul className="float-start">
                            ...
                            <li className="mb-10">
                              Tags: <a rel="tag">Snack</a>, <a rel="tag">Organic</a>, <a rel="tag">Brown</a>
                            </li>
                            <li>
                              Stock:
                          ...
                          <div className="tab-pane fade show active" id="Description">
                            <div className="">
                              <p>
                                ...
                                unaccountably and meadowlark near unblushingly crucial scallop tightly neurotic hungrily some and dear furiously this apart.
                              </p>
                              <p>
                                Spluttered narrowly yikes left moth in yikes bowed this that grizzly much hello on spoon-fed that alas rethought much decently richly and wow
                                against the frequent fluidly at formidable acceptably flapped besides and much circa far over the bucolically hey precarious goldfinch mastodon
                                  ...
                                  <div className="comment-list">
                                    <div className="single-comment justify-content-between d-flex mb-30">
                                      <div className="user justify-content-between d-flex">
                                        <div className="thumb text-center">
                                          ...
                                          <a className="font-heading mt-10 text-brand">Sienna</a>
                                        </div>
                                        <div className="desc">
                                          ...
                                          <p className="mb-10">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus, suscipit exercitationem accusantium obcaecati quos voluptate
                                            nesciunt facilis itaque modi commodi dignissimos sequi repudiandae minus ab deleniti totam officia id incidunt?{" "}
                                    ...
                                    <div className="single-comment justify-content-between d-flex mb-30 ml-30">
                                      <div className="user justify-content-between d-flex">
                                        <div className="thumb text-center">
                                          <img src={Img1} className="mb-10" alt="" />
                                          <a className="font-heading mt-10 text-brand">Brenna</a>
                                        </div>
                                        <div className="desc">
                                          <div className="d-flex justify-content-between mb-10">
                                            <div className="d-flex align-items-center">
                                    ...
                                    <div className="single-comment justify-content-between d-flex">
                                      <div className="user justify-content-between d-flex">
                                        <div className="thumb text-center">
                                          <img src={Img1} className="mb-10" alt="" />
                                          <a className="font-heading mt-10 text-brand">Gemma</a>
                                        </div>
                                        <div className="desc">
                                          <div className="d-flex justify-content-between mb-10">
                                            <div className="d-flex align-items-center">
