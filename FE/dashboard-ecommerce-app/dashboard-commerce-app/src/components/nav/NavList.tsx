    ...
    <>
      ...
      >
        <div className="sidenav-header">
          ...
          >
            <img
              src="./src/assets/img/logo-ct.png"
        ...
        >
          <ul className="navbar-nav">
            ...
            <NavItem url="/category" title="Danh mục " Icon={HomeIcon} />
            <NavItem url="/product" title="Sản phẩm" Icon={HomeIcon} />
            <NavItem url="/login" title="Log out" Icon={HomeIcon} />
          </ul>
        </div>
